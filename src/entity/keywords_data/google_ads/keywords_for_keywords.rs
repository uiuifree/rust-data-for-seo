...
/// A keyword result item from the Google Ads Keywords For Keywords endpoint.
...
pub struct KeywordsDataApiGoogleAdsKeywordsForKeywordsTask {
    ...
    pub keyword_annotations:
        Option<KeywordsDataApiGoogleAdsKeywordsForKeywordsTaskKeywordAnnotations>,
}
