use crate::entity::BacklinksApiElementBacklinksTimeseriesNewLostSummary;
use serde::{Deserialize, Serialize};

/// Result of the Timeseries New & Lost Summary endpoint: new/lost counts over time.
/// See <https://docs.dataforseo.com/v3/backlinks/timeseries_new_lost_summary/live/>.
#[derive(Debug, Default, Serialize, Deserialize, Clone)]
pub struct BacklinksApiTimeseriesNewLostSummary {
