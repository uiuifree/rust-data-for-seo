...
/// A page summary item shared by the Domain Pages Summary and Bulk Pages Summary endpoints.
/// See <https://docs.dataforseo.com/v3/backlinks/domain_pages_summary/live/>
/// and <https://docs.dataforseo.com/v3/backlinks/bulk_pages_summary/live/>.
...
pub struct BacklinksApiElementBacklinksPageSummary {
    ...
    pub rank: Option<i32>,
    /// Rank of the page's main domain on the configured scale.
    pub main_domain_rank: Option<i32>,
