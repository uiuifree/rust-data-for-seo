...
impl KeywordsDataApiGoogle<'_> {
    ...
    pub async fn keywords_for_keywords_tasks_ready(&self) -> DataForSeoApiResponse<KeywordsDataApiTaskReadyResult> {
        self.client.keywords_data().task_ready_se("google/keywords_for_keywords").await
    }
    pub async fn keywords_for_keywords_tasks_fixed(&self) -> DataForSeoApiResponse<KeywordsDataApiTaskReadyResult> {
        self.client.keywords_data().task_fixed_se("google/keywords_for_keywords").await
    }
